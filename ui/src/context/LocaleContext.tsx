...
const looseJaTextMap: Record<string, string> = {
  ...
  "Create from instruction": "指示から作成",
  "Create new agent": "新規エージェントを作成",
  "Create new project": "新規プロジェクトを作成",
  "Global instruction": "全体指示",
  "Global Instruction": "全体指示",
  "Write one instruction. We suggest Issue/Goal/Project, and you can open a draft or create directly.":
    "指示を1つ入力してください。Issue/Goal/Project を提案し、下書きを開くか直接作成できます。",
  "e.g. 来月までにオンボーディング完了率を15%改善したい。まずはログイン導線の不具合修正をAliceに割り当てる。":
    "例: 来月までにオンボーディング完了率を15%改善したい。まずはログイン導線の不具合修正をAliceに割り当てる。",
  "Tip: `Cmd/Ctrl + Enter` to analyze.": "ヒント: `Cmd/Ctrl + Enter` で解析できます。",
  Analyze: "解析",
  "Suggested target": "推奨ターゲット",
  Cancel: "キャンセル",
  "Open Draft": "下書きを開く",
  "Create now": "今すぐ作成",
  "Creating…": "作成中…",
  "Please enter an instruction first.": "先に指示を入力してください。",
  "Select at least one issue candidate.": "Issue候補を1つ以上選択してください。",
  "Failed to create item from instruction.": "指示からの作成に失敗しました。",
  "Opened draft with remaining fields.": "残りの項目を補完できる下書きを開きました。",
