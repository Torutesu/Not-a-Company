...
Not a Company CLI now supports both:
...
`agent local-cli` is the quickest way to run local Claude/Codex manually as a Not a Company agent:

- creates a new long-lived agent API key
- installs missing Not a Company skills into `~/.codex/skills` and `~/.claude/skills`
