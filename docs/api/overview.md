...
Not a Company exposes a RESTful JSON API for all control plane operations.
...
- Run audit trail: include `X-Not a Company-Run-Id` header on all mutating requests during heartbeats
