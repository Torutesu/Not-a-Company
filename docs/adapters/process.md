...
- Running a Python script that calls the Not a Company API
...
1. Not a Company spawns the configured command as a child process
2. Standard Not a Company environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Not a Company API and perform work.
