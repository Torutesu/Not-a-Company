...
summary: What adapters are and how they connect agents to Not a Company
---

Adapters are the bridge between Not a Company's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Not a Company:
