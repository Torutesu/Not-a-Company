...
Build a custom adapter to connect Not a Company to any agent runtime.
...
2. Build environment with `buildNot a CompanyEnv(agent)` plus context vars
...
Make Not a Company skills discoverable to your agent runtime without writing to the agent's working directory:
